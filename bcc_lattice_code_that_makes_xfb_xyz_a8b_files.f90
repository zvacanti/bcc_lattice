!!!This version of the code implements xyz file format correctly, densiity, rotation
!!!This version we are not sure if it does x8b file format
!!!W are sure it does not work with boundary conditions
!!!file format xfb is not coded in yet
...
subroutine xyz_format(N, positions)
...
inquire(14,opened=xopnd)
open(14,FILE="md.00000000000.xyz",STATUS='UNKNOWN',FORM='FORMATTED')
...
10160	format(i10)
	write(14,10161) 
10161	format(' ')
	write(14,10164) ("O", positions(1,i),positions(2,i),positions(3,i), i=1,N)
